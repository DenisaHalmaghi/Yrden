<form action="./?url=admin/<?php echo $data['operation']; ?>Product/<?php echo $data['id'] ?>" method='POST'>
  ...
  <div class="form__input w-12">
    ...
    <input type="number" min=0 max=100 id="Discount" class='input' name="Discount"
           <?php $viewUtil->printInputData('Discount'); ?>>
    <?php $viewUtil->printError('discount'); ?>
  </div>

  <div class="form__input w-12">
    <label for="Image">Image:</label>
    <input type="text" id="Image" class='input' placeholder="x-y_z.png" name="Image"
           <?php $viewUtil->printInputData('Image'); ?>>
    <?php $viewUtil->printError('image'); ?>
  </div>

  <div class="form__input w-12">
    <label for="Dimensions">Dimensions:</label>
    <input type="text" id="prod" class='input' name="Dimensions" placeholder="30x30x30"
           <?php $viewUtil->printInputData('Dimensions'); ?>>
